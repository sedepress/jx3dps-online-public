...
import { 钩吻断肠普通类型 } from './技能类/钩吻断肠普通'
import { 钩吻断肠追加类型 } from './技能类/钩吻断肠追加'
import { 川乌射罔悟类型 } from './技能类/川乌射罔悟'
import { 青圃着尘悟类型 } from './技能类/青圃着尘悟'
import { 沾衣未妨悟类型 } from './技能类/沾衣未妨悟'
import { 并蒂夺株悟类型 } from './技能类/并蒂夺株悟'
import { 苍棘缚地悟类型 } from './技能类/苍棘缚地悟'
import { 凌然天风悟类型 } from './技能类/凌然天风悟'
import { 中毒DOT类型 } from './DOT类/中毒'
...
export interface 循环基础技能数据类型 {
   ...
   * @name 技能类型
   */
  技能类型: '傍身招式' | '对阵招式' | '绝技技能' | '行忌制方' | '凌波飞叶' | '神农百草' | '其他'
  /**
   * 充能层数
   */
  充能层数?: number
